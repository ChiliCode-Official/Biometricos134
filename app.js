  ...
  card.innerHTML = `
    ...
    <div class="pasante-card-body">
      ${bio.status === 'Pendiente' ? `
        ...
        <!-- Hamster Wheel Animation for Active Pending State (Uiverse.io by Nawsome) -->
      ...
      ` : `
        ...
        <!-- Delivery Van Animation for Active Equipment Checklist State (Uiverse.io by yeisonordonez) -->
